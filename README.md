...
```json
{
    ...
    "properties": {
        ...
        "cecProfile": "SampleString",
        "powerOnCommandHex": "SampleString",
        "powerOffCommandHex": "SampleString",
        "powerStatusCommandHex": "SampleString",
        "inputCommandsHexByInputKey": {
        ...
        "powerOffInputPreCommandHex": "SampleString"
    }
}
```
<!-- END Config Example -->
