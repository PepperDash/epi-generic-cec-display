...
{
    public class CecDisplayFactory : EssentialsPluginDeviceFactory<CecDisplayController>
    {
        public CecDisplayFactory()
        {
        ...
        public override EssentialsDevice BuildDevice(DeviceConfig dc)
        {
            ...
            var config = dc.Properties.ToObject<CecDisplayPropertiesConfig>();
	        if (config != null) return new CecDisplayController(dc.Key, dc.Name, config, comms);
